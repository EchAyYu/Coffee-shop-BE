...
const VoucherRedemption = sequelize.define(
  "VoucherRedemption",
  {
    ...
    voucher_id:    { type: DataTypes.INTEGER, allowNull: false, references: { model: Voucher, key: "id" } },
    id_tk:         { type: DataTypes.INTEGER, allowNull: false },
    code:          { type: DataTypes.STRING(40), allowNull: false, unique: true },
    status:        { type: DataTypes.ENUM("active", "used", "expired", "cancelled"), defaultValue: "active" },
